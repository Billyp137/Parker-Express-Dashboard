...
export default async function handler(req, res) {
  ...
  try {
          ...
          const data = await response.json()
            console.log('keys:', JSON.stringify(Object.keys(data)), 'orders type:', typeof data.orders, 'isArray:', Array.isArray(data.orders))

          // Starshipit returns { orders: [...], total: N }
          // Handle both array and single-object edge cases
          let rawOrders = []
