                      ...
                      <main className="max-w-7xl mx-auto px-6 py-8">
                        ...
                        {error && (
                            <div className="mb-6 bg-red-950 border border-red-900 rounded-xl px-4 py-3 flex items-center gap-3 text-red-400 text-sm">
                                        ...
                                        <span>Could not load live data: <strong>{error}</strong>. Contact Parker Express to check your API configuration.</span>
                            </div>
                              )}
                              ...
                              {trackingResult && (
                                            <div className="bg-card border border-border rounded-xl p-6 animate-fade-up stagger-1">
                                                            ...
                                                            <div className="grid grid-cols-2 gap-4 mb-6 pb-6 border-b border-border">
                                                              ...
                                                              {trackingResult.recipient && <div><div className="text-xs text-zinc-500 mb-1">Recipient</div><div className="text-sm text-zinc-200">{trackingResult.recipient}</div></div>}
                                                              {trackingResult.estDelivery && trackingResult.estDelivery !== '—' && <div><div className="text-xs text-zinc-500 mb-1">Est. Delivery</div><div className="text-sm text-zinc-200">{trackingResult.estDelivery}</div></div>}
                                                            </div>
                                                            ...
                                                            <div className="flex flex-col">
                                                              ...
                                                              {(!trackingResult.events || trackingResult.events.length === 0) && (
                                                                  <div className="text-sm text-zinc-500">No tracking events available yet.</div>
                                                                              )}
                                                            </div>
                                            </div>
                                        )}
